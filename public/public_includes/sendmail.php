...
$from = "nocontestar@acp-contadores.com";
	...
	//if ENVIA POR CORREO LOS ARCHIVOS
		...
		$mail -> From = $from;
		$mail -> FromName = "Aguilera Contadores Públicos S.C "; # Puede obtenerse del formulario, por facilidad se hace de esta manera
		$mail -> AddAddress ($to);
		$mail -> Subject = $sbj;
		$mail -> Body = $msg;
		$mail -> IsHTML (true);
		...
		if (!$mail -> Send ()){
			echo $msg = "No se pudo enviar el email<br>";
			echo $mail->ErrorInfo;
		}
?>